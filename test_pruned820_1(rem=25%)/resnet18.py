...
class ResNet(nn.Module):
    ...
    def choose_num_channels(self, layer_name, cost_red_obj, allow_small_prunings):
        ...
        remain_rate = 0.25
        origin_number_of_channels = 64*(2**(int(layer_name[5])-2))
        minimum_channel_per_layer = int(origin_number_of_channels*remain_rate)
        #print(f'minimum_channel_per_layer:{minimum_channel_per_layer}')
